...
SingleCharge.create!(unit_id: 97, value_cents: 9750_00,
  ...
  bill4 = Bill.create!(
    ...
    shared_fee_value_cents: 400_00,
    single_charge_value_cents: 111_00,
    total_value_cents: 100_00 + 400_00 + 1_200_00 + 111_00,
  ...
  BillDetail.create!(bill_id: bill4.id, description: 'Multa por barulho', value_cents: 111_00, fee_type: :fine)
  ...
  bill5 = Bill.create!(
    ...
    single_charge_value_cents: 444_00,
    total_value_cents: 100_00 + 100_00 + 444_00 + 1_200_00,
    rent_fee_cents: 1_200_00,
