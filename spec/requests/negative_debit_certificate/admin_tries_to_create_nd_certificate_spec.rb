...
RSpec.describe 'NdCertificates', type: :request do
  describe 'GET /index' do
    ...
    it 'nao consegue emitir certificado pois não tem acesso ao condo' do
      ...
      login_as admin, scope: :admin
      get condo_nd_certificates_path(condo_id: units.first.condo_id)

      expect(response).to have_http_status(302)
      expect(flash[:notice]).to eq(I18n.t('errors.unauthorized.not_super_admin'))
