...
describe 'admin cria taxa fixa' do
  ...
  it 'com dados incompletos' do
    ...
    # expect(page).to have_content 'Valor para Apartamento 1 quarto não pode ficar em branco'
    # expect(page).to have_content 'Valor para Apartamento 2 quartos não pode ficar em branco'
    # expect(page).to have_content 'Valor para Apartamento 3 quartos não pode ficar em branco'
